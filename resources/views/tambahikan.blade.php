    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Tambah Jenis Ikan</h2>
                    ...
                    <form class="info">
                        ...
                        <input type="text" name="jenisikan" id="jenisikan" class="input--style-4" required="require">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                   <label for="jumlahikan">Jumlah Ikan</label>
									<input type="text" name="jumlahikan" id="jumlahikan" class="input--style-4" required="require">
                                    </div>
                                </div>
                            </div>
							<div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label for="Tanggal ikan masuk">Tanggal ikan masuk(YY-MM-DD)</label>
...
var ph1 = <?php echo $datasensor ?>;
$(document).ready(() => {
        $('.info').on('submit', () => {
  
            $.ajax({
          url: "http://dprompt.id/restapi/public/kolam/tambahikan/"+ph1,
          type: 'POST',
          data: { 
                  jenisikan: $('#jenisikan').val(),
                  jumlahikan: $('#jumlahikan').val(),
                  tanggalikanmasuk: $('#from-datepicker').val()
				  //token: token
                },
    ...
    window.location.href = '/restapi/public/kolam/daftar';
            ...
            alert('Format tanggal salah, contoh(2020-12-09)');
