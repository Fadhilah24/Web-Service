    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Edit Kolam</h2>
					@foreach($registrasi_kolam as $reg)
                    <form action="/restapi/public/kolam/updatekolam/{{ $reg->id}}" method="POST">
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label for="nama_kolam">Nama Kolam</label>
                        <input type="text" name="nama_kolam" id="nama_kolam" class="input--style-4" value="{{ $reg->nama_kolam}}" >
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                   <label for="lokasi">Lokasi</label>
									<input type="text" name="lokasi" id="lokasi" class="input--style-4" value="{{ $reg->lokasi}}" >
                                    </div>
                                </div>
                            </div>
