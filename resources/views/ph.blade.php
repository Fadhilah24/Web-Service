...
function create_table_date(data2)
    {
        ...
        var dt4 = $("#from-datepicker2").val().toString();
        var d4 = new Date(dt4);
        var day4 = d4.getDate();
        var month4 = d4.getMonth();
        var year4 = d4.getFullYear();
        if(day3== day4 && month3==month4 && year3==year4 ){ 
            
             dataph[count1] = JSON.parse(data2[i]['ph']);
            tanggal[count1] = data2[i]['created_at'];
            count1 ++ ;
        }
...
function create_table(data2)
    {
        ...
        if(datadate1 == day5 && month==month1 && year==year1 ){ 
             ...
             dataph[count] = JSON.parse(data2[j]['ph']);
